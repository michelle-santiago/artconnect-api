...
RSpec.describe "home", type: :request do
  ...
  describe "GET /index as guest" do
    it "renders an unsuccessful response" do
      get api_v1_home_url, headers: { Authorization: jwt_encode(guest) }
  ...
  describe "GET /index with invalid token" do
    it "renders a successful response" do
      get api_v1_home_url, headers: { Authorization: "token" }
  ...
  describe "GET /index as an artist" do
    it "renders a successful response" do
      get api_v1_home_url, headers: { Authorization: jwt_encode(artist) }
  ...
  describe "GET /index as a client" do
    it "renders a successful response" do
      get api_v1_home_url, headers: { Authorization: jwt_encode(client) }
      expect(response).to have_http_status(200)
    end
  end
